(function(global) {
    ...
    function initBuffersTriangle() {
        var vertices = new Float32Array([
            //x, y      r,g,b
          +0.15, -0.8,  0.1, 1.0, 0.6,
          0.0, -0.8,   10.7, 0.0, 1.0,
          0.0, +0.8,   10.1, 1.0, 0.6,
  
          0.0, +0.8,   10.1, 1.0, 0.6,
          +0.15, +0.8,  0.7, 0.0, 1.0,
          +0.15, -0.8,  0.1, 1.0, 0.6,
  
          +0.15, -0.2,  0.1, 1.0, 0.6,
          +0.25, 0.0,   0.7, 0.0, 1.0,
          +0.15, +0.2,  0.1, 1.0, 0.6,
  
          +0.15, -0.2,  0.7, 0.0, 1.0,
          +0.45, -0.8,  0.1, 1.0, 0.6,
          +0.25, 0.0,   0.7, 0.0, 1.0,
  
          +0.45, -0.8,  0.1, 1.0, 0.6,
          +0.55, -0.6,  0.7, 0.0, 1.0,
          +0.25, 0.0,  1.0, 1.0, 0.6,

          +0.15, +0.2,  0.1, 1.0, 0.6,
          +0.45, +0.8,  0.7, 0.0, 1.0,
          +0.25, 0.0,   0.1, 1.0, 0.6,
    
          +0.45, +0.8,  0.7, 0.0, 1.0, 
          +0.55, +0.6,  0.1, 1.0, 0.6,
          +0.25, 0.0,   0.7, 0.0, 1.0,  
        ]);
    ...
    function draw(){
        ...
        function render(){
            ...
            theta2 += Math.PI * 0.0003;
            gl.uniform1f(theta2Loc, theta2);

            if(isGrow) {scale += 0.0003}
            else{
                scale -= 0.0003;
            }
